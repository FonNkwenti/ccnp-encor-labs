#!/usr/bin/env python3
"""
Solution Restoration: OSPF Lab 02 -- Network Types + DR/BDR Manipulation
...
multi-area OSPFv2 + OSPFv3 state with priorities tuned and both transit
links converted to OSPF network type point-to-point.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore OSPF lab-02 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: OSPF Lab 02 -- Network Types + DR/BDR")
    print("=" * 60)
