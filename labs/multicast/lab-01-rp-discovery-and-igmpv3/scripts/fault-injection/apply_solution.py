#!/usr/bin/env python3
"""
Solution Restoration: Multicast Lab 01 -- RP Discovery and IGMPv3
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore Multicast lab-01 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Multicast Lab 01 (RP Discovery + IGMPv3)")
    print("=" * 60)
    try:
