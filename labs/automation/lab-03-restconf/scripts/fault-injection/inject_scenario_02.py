#!/usr/bin/env python3
"""
Fault Injection: Scenario 02 -- Automation Lab 03 (RESTCONF)

Injects Ticket 2 fault. Work through the ticket in workbook.md Section 9
...
FAULT: dict[str, list[str]] = {
    "R1": [
        "no username admin",
        "username admin privilege 1 secret WrongPass-2026",
    ],
}


def main() -> int:
    parser = argparse.ArgumentParser(description="Inject Scenario 02 for Automation lab-03")
    ...
    if fail:
        ...
        return 1
    print("[+] Scenario 02 injected. Work through Ticket 2 in workbook.md.")
    return 0
