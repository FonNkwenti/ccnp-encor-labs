#!/usr/bin/env python3
"""
Lab Setup: BGP Lab 01 -- iBGP, Dual-Homing, and Dual-Stack
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for BGP lab-01")
    ...
    print("=" * 60)
    print("Lab Setup: BGP Lab 01 -- iBGP, Dual-Homing, and Dual-Stack")
    print("=" * 60)
