#!/usr/bin/env python3
"""
Lab Setup: Automation Lab 02 -- NETCONF Configuration and Verification

Pushes initial-configs/<node>.cfg to each device via its EVE-NG console
port. Initial configs include hostname, credentials, SSH, OSPF, RESTCONF,
and EEM applets (from prior labs). NETCONF is NOT pre-configured --
students enable it on R1 and R2 as part of Task 1.
...
DEFAULT_LAB_PATH = "automation/lab-02-netconf.unl"
ROUTERS = ["R1", "R2", "R3"]
DEVICES = ROUTERS
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for automation lab-02")
    ...
    print("=" * 60)
    print("Lab Setup: Automation Lab 02 -- NETCONF")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] All devices configured: OSPF, SSH, RESTCONF, and EEM applets pre-loaded.")
    print("[*] NETCONF is NOT pre-configured. Students enable it on R1/R2 in Task 1.")
    return 0
