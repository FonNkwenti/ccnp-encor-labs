#!/usr/bin/env python3
"""
Fault Injection: Scenario 03 -- Wrong Access VLAN on PC2 Port

Target:     SW3 (Gi1/1, access port to PC2)
Injects:    Changes access VLAN from 20 -> 30
...
PREFLIGHT_EXPECT = "access vlan 20"


def preflight(conn) -> bool:
    output = conn.send_command(PREFLIGHT_CMD)
    if PREFLIGHT_EXPECT not in output:
        print(f"[!] Pre-flight failed: Gi1/1 does not have '{PREFLIGHT_EXPECT}'.")
