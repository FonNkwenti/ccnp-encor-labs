#!/usr/bin/env python3
"""
Lab Setup: Switching Lab 04 -- Layer 2 Full Configuration (Capstone I)
...
Capstone I is a clean-slate lab: initial configs contain only hostname,
no-ip-domain-lookup, and comfort lines (plus R1 Loopback0). The student
builds every VLAN, trunk, EtherChannel, STP tuning, and router-on-a-stick
sub-interface from scratch per workbook.md Section 5.
...
def main() -> int:
    ...
    print("=" * 60)
    print("Lab Setup: Switching Lab 04 -- L2 Capstone I (clean slate)")
    print("=" * 60)
