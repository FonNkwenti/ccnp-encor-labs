#!/usr/bin/env python3
"""
Solution Restoration: Security Lab 01
...
state with AAA fully configured on R1.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore security lab-01 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Security Lab 01")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] All devices restored to solution state with SSH and AAA enabled.")
    return 0
