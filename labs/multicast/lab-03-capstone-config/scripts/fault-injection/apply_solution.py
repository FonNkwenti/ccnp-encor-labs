#!/usr/bin/env python3
"""
Solution Restoration: Multicast Lab 03 -- Capstone I
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore Multicast lab-03 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Multicast Lab 03 (Capstone I)")
    print("=" * 60)
    try:
