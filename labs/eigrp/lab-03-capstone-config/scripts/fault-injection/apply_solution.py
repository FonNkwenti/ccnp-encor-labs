#!/usr/bin/env python3
"""
Solution Restoration: EIGRP Lab 03 -- Full Protocol Mastery (Capstone I)
...
R4 as stub, R3 summaries on both uplinks, R2-R3 100 Mbps bandwidth, and
variance 8 on R2.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore EIGRP lab-03 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: EIGRP Lab 03")
    print("=" * 60)
