#!/usr/bin/env python3
"""
Solution Restoration: OSPF Lab 05 -- Capstone I: Full Protocol Mastery

Pushes the full solution configs from ../../solutions/ to all six routers,
overwriting any injected faults and restoring the lab to the complete
multi-area OSPF solution state.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore OSPF lab-05 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: OSPF Lab 05 -- Capstone I")
    print("=" * 60)
