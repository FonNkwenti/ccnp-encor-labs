#!/usr/bin/env python3
"""
Solution Restoration: IP Services Lab 04 -- Full Mastery Capstone I

Pushes the full solution configs from ../../solutions/ to R1, R2, R3,
returning the lab to the known-good end-state with OSPFv2, OSPFv3, NTP,
NAT/PAT, and VRRPv3 dual-stack all operational.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore IP Services lab-04 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: IP Services Lab 04 (Capstone I)")
    print("=" * 60)
