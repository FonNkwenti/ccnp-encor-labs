#!/usr/bin/env python3
"""
Fault Injection: Scenario 01 -- Multicast Lab 00
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Inject Scenario 01 for Multicast lab-00")
    ...
    print("=" * 60)
    print("Fault Injection: Scenario 01 (Multicast Lab 00)")
    print("=" * 60)
