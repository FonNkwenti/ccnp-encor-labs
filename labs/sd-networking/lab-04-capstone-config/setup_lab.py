...
class LabSetup:
    ...
    def print_viptela_instructions(self):
        print()
        print("=" * 60)
        print("Viptela SD-WAN Devices — Manual Reset Required")
        print("=" * 60)
        print()
        print("This is a CLEAN-SLATE capstone lab.")
        print("Each Viptela device starts with VPN 0 interface addressing only.")
        print("The system block is intentionally absent — you configure it.")
        print()
        print("Apply each Viptela initial-config via console to reset to clean-slate state:")
        print()
        ...
        print()
        print("After reset, all Viptela devices will have:")
        print("  - VPN 0 interface address and default route")
        print("  - NO system block, NO tunnel-interface, NO VPN 1, NO policy")
        print()

    def run(self):
        print(f"SD-WAN Lab 04 — Capstone I Setup (EVE-NG: {self.eve_ng_host})")
        print()
        ...
        print("After resetting Viptela initial-configs, proceed to workbook.md Section 5.")
        print("Remember: configure vBond first, then vSmart, then vManage, then vEdges.")
