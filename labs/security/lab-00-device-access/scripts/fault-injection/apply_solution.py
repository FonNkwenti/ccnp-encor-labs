#!/usr/bin/env python3
"""
Solution Restoration: Security Lab 00
...
DEFAULT_LAB_PATH = "security/lab-00-device-access.unl"
DEVICES = ["R1", "R2", "R3", "SW1"]
...
def restore(host: str, name: str, port: int) -> bool:
    ...
    try:
        ...
        # RSA key generation must run in EXEC mode after config push
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore security lab-00 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Security Lab 00")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] All devices restored to solution state with SSH enabled.")
    return 0
