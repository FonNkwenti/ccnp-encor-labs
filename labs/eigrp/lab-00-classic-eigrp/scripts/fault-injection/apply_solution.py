#!/usr/bin/env python3
"""
Solution Restoration: EIGRP Lab 00 -- Classic EIGRP Fundamentals

Pushes the full solution configs from ../../solutions/ to all three routers,
restoring the lab to complete, correct EIGRP convergence state.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore EIGRP lab-00 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: EIGRP Lab 00")
    print("=" * 60)
