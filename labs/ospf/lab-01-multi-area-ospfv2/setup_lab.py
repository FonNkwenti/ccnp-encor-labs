#!/usr/bin/env python3
"""
Lab Setup: OSPF Lab 01 -- Multi-Area OSPFv2 + Dual-Stack
...
The initial-configs here are the lab-00 solution state (single-area
OSPFv2 on every router). The student then reconfigures R2/R3 as ABRs,
moves R4 into Area 1 and R5 into Area 2, and adds OSPFv3 for IPv6.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for OSPF lab-01")
    ...
    print("=" * 60)
    print("Lab Setup: OSPF Lab 01 -- Multi-Area OSPFv2 + Dual-Stack")
    print("=" * 60)
