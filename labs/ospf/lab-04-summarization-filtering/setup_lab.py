#!/usr/bin/env python3
"""
Lab Setup: OSPF Lab 04 -- Inter-Area Summarization and Filtering
...
The initial-configs here are the lab-03 solution state (Totally Stubby
Area 1, NSSA Area 2, R6 as second internal Area 1 router, R5 as ASBR).
The student then configures summarization loopbacks on R4, inter-area
summarization on R2, ASBR summarization on R5, and distribute-list
filtering on R1.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for OSPF lab-04")
    ...
    print("=" * 60)
    print("Lab Setup: OSPF Lab 04 -- Summarization and Filtering")
    print("=" * 60)
