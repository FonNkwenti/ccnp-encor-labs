# Fault Injection -- Switching Lab 04: Layer 2 Full Configuration (Capstone I)
...
- EVE-NG lab `switching/lab-04-capstone-config.unl` imported and **STARTED**
...
- `--lab-path <path>`: Path of the .unl on EVE-NG (default:
  `switching/lab-04-capstone-config.unl`). Override if you imported
...
|----------|---------------|----------------|
| 01 | SW2 | `python3 inject_scenario_01.py --host <eve-ng-ip>` |
| 02 | SW3 | `python3 inject_scenario_02.py --host <eve-ng-ip>` |
