#!/usr/bin/env python3
"""
Fault Injection: Scenario 02 -- vSmart VPN-List Policy Break
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Inject Scenario 02 fault onto vSmart"
    )
    parser.add_argument(
        "--host",
...
def inject(eve_ng_host: str) -> int:
    ...
    print("[+] Fault injected on vSmart. Scenario 02 is now active.")
    print("=" * 60)
    return 0
