#!/usr/bin/env python3
"""
Lab Setup: BGP Lab 00 -- eBGP Peering Fundamentals
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for BGP lab-00")
    ...
    print("=" * 60)
    print("Lab Setup: BGP Lab 00 -- eBGP Peering Fundamentals")
    print("=" * 60)
