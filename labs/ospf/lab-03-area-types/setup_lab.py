#!/usr/bin/env python3
"""
Lab Setup: OSPF Lab 03 -- Area Types: Stub, Totally Stubby, and NSSA
...
The initial-configs here are the lab-02 solution state (full multi-area
OSPFv2 + OSPFv3 dual-stack with DR/BDR tuning and p2p network types) for
R1-R5, and a base IP-only config for R6 (new in this lab). The student
then configures area types (Totally Stubby for Area 1, NSSA for Area 2)
and brings R6 into the OSPF domain.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for OSPF lab-03")
    ...
    print("=" * 60)
    print("Lab Setup: OSPF Lab 03 -- Area Types")
    print("=" * 60)
