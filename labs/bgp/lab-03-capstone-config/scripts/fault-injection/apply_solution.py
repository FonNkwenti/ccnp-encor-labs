#!/usr/bin/env python3
"""
Solution Restoration: BGP Lab 03 -- Full Protocol Mastery (Capstone I)

Pushes the full solution configs from ../../solutions/ to R1, R2, R3, R4,
delivering the complete reference build for comparison against your
own capstone implementation.

Use this to:
  - Compare your build against the reference end-state
  - Skip to end-state if you need to move on to Lab 04
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore BGP lab-03 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: BGP Lab 03 (Capstone I reference)")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] All devices restored to capstone I reference solution.")
    return 0
