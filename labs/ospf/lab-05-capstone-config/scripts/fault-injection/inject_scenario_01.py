#!/usr/bin/env python3
"""
Fault Injection: Scenario 01 -- No OSPF Neighbor on R4's Uplink to R2

Target:     R2 (ABR Area 0/1)
Injects:    Changes GigabitEthernet0/1 network type from point-to-point
            to broadcast. R4 retains point-to-point. The type mismatch
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Inject Scenario 01 (network type mismatch on R2 Gi0/1)")
