#!/usr/bin/env python3
"""
Lab Setup: EIGRP Lab 02 -- Stub, Summarization, and Variance
...
initial-configs carry forward the lab-01 solution (named-mode dual-stack)
plus R3's four Branch B loopbacks and R4's IP-only base. The student adds
stub, summarization, bandwidth manipulation, and variance during the lab.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for EIGRP lab-02")
    ...
    print("=" * 60)
    print("Lab Setup: EIGRP Lab 02 -- Stub, Summarization, Variance")
    print("=" * 60)
