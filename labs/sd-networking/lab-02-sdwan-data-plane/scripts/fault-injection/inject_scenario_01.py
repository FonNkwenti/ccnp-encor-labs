...
Injects:     app-route-policy removed from apply-policy on vSmart
Target:      vSmart (Viptela OS)
Fault Type:  App-Route Policy Not Applied
...
FAULT_COMMANDS = [
    "apply-policy",
    "no site-list SITE2 app-route-policy APP-AWARE-ROUTING",
    "no site-list SITE1 app-route-policy APP-AWARE-ROUTING",
    "commit",
]


def inject_fault(host: str, port: int) -> int:
    """Connect to vSmart and inject the app-route-policy fault."""
