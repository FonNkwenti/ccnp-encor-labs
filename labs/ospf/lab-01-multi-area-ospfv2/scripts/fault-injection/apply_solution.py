#!/usr/bin/env python3
"""
Solution Restoration: OSPF Lab 01 -- Multi-Area OSPFv2 + Dual-Stack

Pushes the full solution configs from ../../solutions/ to all five routers,
overwriting any injected faults and restoring the lab to a known-good
multi-area OSPFv2 + OSPFv3 dual-stack state.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore OSPF lab-01 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: OSPF Lab 01 -- Multi-Area OSPFv2 + Dual-Stack")
    print("=" * 60)
