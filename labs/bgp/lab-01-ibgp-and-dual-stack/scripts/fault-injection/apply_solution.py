#!/usr/bin/env python3
"""
Solution Restoration: BGP Lab 01 -- iBGP, Dual-Homing, and Dual-Stack

Pushes the full solution configs from ../../solutions/ to R1, R2, and R3,
restoring the lab to complete, correct dual-stack iBGP/eBGP state.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore BGP lab-01 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: BGP Lab 01")
    print("=" * 60)
