#!/usr/bin/env python3
"""
Solution Restoration: IP Services Lab 01 -- Static NAT, Dynamic NAT, and PAT

Pushes the full solution configs from ../../solutions/ to R1, R2, R3,
returning the lab to the known-good end-state with all NAT rules in place.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore IP Services lab-01 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: IP Services Lab 01 (NAT/PAT)")
    print("=" * 60)
