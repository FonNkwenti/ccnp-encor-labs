#!/usr/bin/env python3
"""
Solution Restoration: OSPF Lab 06 -- Capstone II: Comprehensive Troubleshooting

Pushes the full solution configs from ../../solutions/ to all six routers,
restoring the lab to complete, correct multi-area OSPF convergence state.

Use this to:
  - Reset after completing the capstone challenge
  - Reset before practicing an individual fault in isolation
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore OSPF lab-06 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: OSPF Lab 06 -- Capstone II")
    print("=" * 60)
