#!/usr/bin/env python3
"""
Lab Setup: EIGRP Lab 03 -- Full Protocol Mastery (Capstone I)
...
initial-configs carry only IP and IPv6 addressing -- no EIGRP process.
This is a clean-slate capstone: the student builds the entire dual-stack
named-mode EIGRP domain (adjacencies, stub, summarization, bandwidth,
variance, passive-interfaces) from scratch.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for EIGRP lab-03")
    ...
    print("=" * 60)
    print("Lab Setup: EIGRP Lab 03 -- Full Protocol Mastery")
    print("=" * 60)
