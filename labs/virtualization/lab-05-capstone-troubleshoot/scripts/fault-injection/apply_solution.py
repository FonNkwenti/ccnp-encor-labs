#!/usr/bin/env python3
"""
Solution Restoration — Virtualization Lab 05 (Capstone II)
...
Run this:
  ...
  * to reset between repeated attempts at the capstone

Console ports are discovered via the EVE-NG REST API, so the lab must be
STARTED in EVE-NG before running.

NOTE: We push the FULL solution config — not just targeted reversals. This
guarantees the lab is truly in "known-good" state even if the student has made
exploratory changes beyond the pre-injected faults.
"""
...
def main() -> int:
    ...
    print("=" * 60)
    print("Solution Restoration: Virtualization Lab 05")
    print("=" * 60)
