#!/usr/bin/env python3
"""
Initial Lab Setup -- Network Assurance Lab 04 (Capstone I — Full Protocol Mastery)
...
you begin Section 5 of the workbook.
...
# labs/network-assurance/lab-04-capstone-config/setup_lab.py
# parents[2] == labs/
