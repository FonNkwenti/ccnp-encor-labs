#!/usr/bin/env python3
"""
Solution Restoration: BGP Lab 04 -- Comprehensive Troubleshooting (Capstone II)

Pushes the full solution configs from ../../solutions/ to R1, R2, R3, R4,
restoring the network to its known-good Capstone I end-state (identical to
lab-03 solutions).

Use this to:
  - Verify the reference end-state after completing all six tickets
  - Reset the network if you get stuck or need a clean slate to retry
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore BGP lab-04 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: BGP Lab 04 (Capstone II reference)")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] All devices restored to capstone II reference solution.")
    return 0
