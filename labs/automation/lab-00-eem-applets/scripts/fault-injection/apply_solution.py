#!/usr/bin/env python3
"""
Solution Restoration: Automation Lab 00 — EEM Applets

Pushes the full solution configs from ../../solutions/ to all devices,
then generates RSA keys to enable SSH. Restores the lab to a known-good
state with all three EEM applets correctly configured on R3.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore automation lab-00 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Automation Lab 00 — EEM Applets")
    print("=" * 60)
    ...
    print("[*] R3: all three EEM applets configured and registered.")
    return 0
