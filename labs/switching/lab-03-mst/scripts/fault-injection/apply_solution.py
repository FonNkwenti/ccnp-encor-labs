#!/usr/bin/env python3
"""
Solution Restoration: Switching Lab 03 (MST)
...
known-good state (MST region ENCOR-REGION, revision 1, instance 1 = 10,99,
instance 2 = 20,30, SW1 root for MST 1, SW2 root for MST 2).
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore switching lab-03 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Switching Lab 03 (MST)")
    print("=" * 60)
