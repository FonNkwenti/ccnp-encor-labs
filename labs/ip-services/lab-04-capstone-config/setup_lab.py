#!/usr/bin/env python3
"""
Lab Setup: IP Services Lab 04 -- Full Mastery Capstone I

Pushes initial-configs/<node>.cfg to R1, R2, and R3. Initial configs include
only IP addressing and a pre-loaded QoS MQC policy on R1. All routing protocols,
NTP, NAT, and FHRP are NOT pre-configured -- students build everything from
scratch per workbook.md Section 5.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for IP Services lab-04 (Capstone I)")
    ...
    print("=" * 60)
    print("Lab Setup: IP Services Lab 04 -- Full Mastery Capstone I")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] IP addressing applied. Build the complete IP services stack per workbook.md Section 5.")
    return 0
