#!/usr/bin/env python3
"""
Solution Restoration: Automation Lab 02 — NETCONF Configuration and Verification
...
known-good state with NETCONF enabled on R1 and R2.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Restore automation lab-02 to solution state"
    )
    ...
    print("=" * 60)
    print("Solution Restoration: Automation Lab 02 — NETCONF")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] All devices restored. NETCONF is active on R1 and R2 — ready for troubleshooting.")
    return 0
