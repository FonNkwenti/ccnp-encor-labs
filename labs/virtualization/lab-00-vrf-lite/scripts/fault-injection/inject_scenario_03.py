#!/usr/bin/env python3
"""
Fault Injection: Scenario 03 -- R1 LAN Interface in Global Table

Target:     R1
Injects:    GigabitEthernet0/2 removed from VRF CUSTOMER-A and placed
            into the global routing table with the same IP address —
            the LAN subnet becomes globally routed and invisible to the
            VRF-aware gateway expected by PC1.
Fault Type: Interface VRF Assignment Removal
...
FAULT_COMMANDS = [
    ...
    "no vrf forwarding CUSTOMER-A",
    "ip address 192.168.1.1 255.255.255.0",
]
PREFLIGHT_CMD = "show running-config interface GigabitEthernet0/2"
PREFLIGHT_EXPECT = "vrf forwarding CUSTOMER-A"
