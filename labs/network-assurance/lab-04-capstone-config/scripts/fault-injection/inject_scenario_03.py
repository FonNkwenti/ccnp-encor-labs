...
# labs/network-assurance/lab-04-capstone-config/scripts/fault-injection/ -> parents[3] = labs/
sys.path.insert(0, str(SCRIPT_DIR.parents[3] / "common" / "tools"))
from eve_ng import EveNgError, connect_node, discover_ports, require_host  # noqa: E402

DEFAULT_LAB_PATH = "ccnp-encor/network-assurance/lab-04-capstone-config.unl"
DEVICE_NAME = "R1"
...
FAULT_COMMANDS = [
    ...
    "ip sla schedule 3 life forever start-time pending",
]
