#!/usr/bin/env python3
"""
Solution Restoration: IP Services Lab 02 -- HSRP

Pushes the full solution configs from ../../solutions/ to R1, R2, R3,
returning the lab to the known-good end-state with HSRPv2 group 1 and 2,
interface tracking, and dual-stack IPv6 in place.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore IP Services lab-02 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: IP Services Lab 02 (HSRP)")
    print("=" * 60)
