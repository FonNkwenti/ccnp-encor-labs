#!/usr/bin/env python3
"""
Solution Restoration: EIGRP Lab 02 -- Stub, Summarization, Variance

Pushes the full solution configs from ../../solutions/ to all four routers,
restoring the lab to complete, correct state: R4 as EIGRP stub, R3 with
10.3.0.0/22 and 2001:DB8:3::/62 summaries, R2-R3 bandwidth set to 100 Mbps,
and variance 8 applied on R2 for unequal-cost load balancing.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore EIGRP lab-02 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: EIGRP Lab 02")
    print("=" * 60)
