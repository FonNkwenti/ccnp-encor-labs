#!/usr/bin/env python3
"""
Lab Setup: IP Services Lab 03 -- VRRP and Dual-Stack Gateway Redundancy

Pushes initial-configs/<node>.cfg to R1, R2, and R3. Initial configs include
OSPF, NTP, QoS, NAT, IPv6, and HSRP from lab-02. HSRP is present and must be
removed by the student. VRRPv3 is NOT pre-configured -- students build it per
workbook.md Section 5.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for IP Services lab-03 (VRRP)")
    ...
    print("=" * 60)
    print("Lab Setup: IP Services Lab 03 -- VRRP and Dual-Stack")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] Initial configs applied. Remove HSRP and configure VRRPv3 per workbook.md Section 5.")
    return 0
