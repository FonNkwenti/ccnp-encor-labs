#!/usr/bin/env python3
"""
Lab Setup: Multicast Lab 04 -- Comprehensive Troubleshooting (Capstone II)

Pushes initial-configs/<node>.cfg to R1, R2, R3, R4.
PC1 and PC2 read their .vpc files on boot.

The initial configs ARE the pre-broken state -- six faults are baked in across
R2/R3/R4. Work through the tickets in workbook.md Section 9 to diagnose and
restore full multicast operation.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Push pre-broken configs for Multicast lab-04 (Capstone II)"
    )
    ...
    print("=" * 60)
    print("Lab Setup: Multicast Lab 04 -- Capstone II (Troubleshooting)")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] Pre-broken configs applied. Work the tickets in workbook.md Section 9.")
    return 0
