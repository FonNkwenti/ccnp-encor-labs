#!/usr/bin/env python3
"""
Solution Restoration: Automation Lab 03 -- RESTCONF and REST API Interpretation
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore Automation lab-03 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Automation Lab 03 (RESTCONF)")
    print("=" * 60)
