#!/usr/bin/env python3
"""
Solution Restoration: Switching Lab 05 (Capstone II -- Troubleshooting)
...
known-good state (the Lab 04 target topology, fully healed).

PC1 and PC2 are VPCs in EVE-NG and are not pushed from here -- their
configuration is loaded from the .vpc files on boot.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore switching lab-05 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Switching Lab 05 (Capstone II)")
    print("=" * 60)
