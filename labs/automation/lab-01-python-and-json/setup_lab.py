#!/usr/bin/env python3
"""
Lab Setup: Automation Lab 01 -- Python Scripting and JSON Construction

Pushes initial-configs/<node>.cfg to each device via its EVE-NG console
port. Initial configs include hostname, credentials, SSH, OSPF, and the
EEM applets from lab-00. RESTCONF is NOT pre-configured -- students enable
it on R1 as part of Task 6.
...
DEFAULT_LAB_PATH = "automation/lab-01-python-and-json.unl"
ROUTERS = ["R1", "R2", "R3"]
DEVICES = ROUTERS
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for automation lab-01")
    ...
    print("=" * 60)
    print("Lab Setup: Automation Lab 01 -- Python Scripting and JSON")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] All devices configured: OSPF, SSH, and EEM applets pre-loaded.")
    print("[*] RESTCONF is NOT pre-configured. Students enable it on R1 in Task 6.")
    return 0
