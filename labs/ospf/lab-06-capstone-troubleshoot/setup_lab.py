#!/usr/bin/env python3
"""
Lab Setup: OSPF Lab 06 -- Capstone II: Comprehensive Troubleshooting
...
The initial-configs contain a complete multi-area OSPF topology with FIVE
pre-injected concurrent faults. The student must diagnose and fix all five
faults to restore full convergence. Do NOT run apply_solution.py before
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push broken initial configs for OSPF lab-06")
    ...
    print("=" * 60)
    print("Lab Setup: OSPF Lab 06 -- Capstone II: Comprehensive Troubleshooting")
    print("WARNING: This pushes the PRE-BROKEN config. Do not run apply_solution.py")
    print("         before completing your diagnosis.")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] Broken state loaded. Begin your OSPF troubleshooting.")
    return 0
