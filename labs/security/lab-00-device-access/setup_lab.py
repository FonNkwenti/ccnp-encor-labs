#!/usr/bin/env python3
"""
Lab Setup: Security Lab 00 -- Lines, Local Users, and SSH Hardening
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for security lab-00")
    ...
    print("=" * 60)
    print("Lab Setup: Security Lab 00 -- Lines, Local Users, SSH")
    print("=" * 60)
    ...
    print("[*] Note: SSH is NOT pre-configured. Students configure it as part of the lab.")
    return 0
