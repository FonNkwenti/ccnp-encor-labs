#!/usr/bin/env python3
"""
Solution Restoration: Multicast Lab 02 -- SSM, Bidir, and MSDP

Pushes the full solution configs from ../../solutions/ to R1, R2, R3, R4,
returning the lab to the known-good end-state with all faults resolved.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore Multicast lab-02 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Multicast Lab 02 (SSM + Bidir + MSDP)")
    print("=" * 60)
    try:
