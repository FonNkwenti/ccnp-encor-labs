#!/usr/bin/env python3
"""
Solution Restoration: EIGRP Lab 04 -- Comprehensive Troubleshooting (Capstone II)

Pushes the full solution configs from ../../solutions/ to all four routers,
restoring the lab to a complete, correct state: named-mode dual-stack EIGRP,
R1 default K-values, R3 passive-interface only on PC1 LAN, R2 fully enrolled
with variance 8 in both AFs, and R4 as a `connected` stub.

Use this to:
  - Reset after completing the full 5-fault scenario
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore EIGRP lab-04 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: EIGRP Lab 04")
    print("=" * 60)
