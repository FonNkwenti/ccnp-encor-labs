#!/usr/bin/env python3
"""
Lab Setup: IP Services Lab 01 -- Static NAT, Dynamic NAT, and PAT

Pushes initial-configs/<node>.cfg to R1, R2, and R3. Initial configs
include OSPF, NTP, and QoS from lab-00. NAT is NOT pre-configured --
students build it per workbook.md Section 5.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for IP Services lab-01 (NAT/PAT)")
    ...
    print("=" * 60)
    print("Lab Setup: IP Services Lab 01 -- Static NAT, Dynamic NAT, and PAT")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] Initial configs applied. Configure NAT/PAT per workbook.md Section 5.")
    return 0
