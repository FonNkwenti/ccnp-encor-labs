#!/usr/bin/env python3
"""
Lab Setup: BGP Lab 02 -- Best Path Selection and Attributes
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for BGP lab-02")
    ...
    print("=" * 60)
    print("Lab Setup: BGP Lab 02 -- Best Path Selection and Attributes")
    print("=" * 60)
