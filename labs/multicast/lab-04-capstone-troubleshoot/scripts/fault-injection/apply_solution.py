#!/usr/bin/env python3
"""
Solution Restoration: Multicast Lab 04 -- Comprehensive Troubleshooting (Capstone II)
...
DEFAULT_LAB_PATH = "multicast/lab-04-capstone-troubleshoot.unl"
DEVICES = ["R1", "R2", "R3", "R4"]
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Restore Multicast lab-04 to solution state"
    )
    ...
    print("=" * 60)
    print("Solution Restoration: Multicast Lab 04 (Capstone II reference)")
    print("=" * 60)
