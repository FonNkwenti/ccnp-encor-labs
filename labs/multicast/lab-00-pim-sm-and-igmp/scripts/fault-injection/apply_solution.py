#!/usr/bin/env python3
"""
Solution Restoration: Multicast Lab 00 -- PIM Sparse Mode, IGMP, and RPF Fundamentals
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore Multicast lab-00 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Multicast Lab 00 (PIM-SM + IGMP)")
    print("=" * 60)
    try:
