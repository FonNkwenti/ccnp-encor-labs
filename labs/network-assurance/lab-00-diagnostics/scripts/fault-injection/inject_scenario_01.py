...
The lab must be STARTED in EVE-NG before running this script.
"""
...
# labs/network-assurance/lab-00-diagnostics/scripts/fault-injection/ -> parents[3] = labs/
sys.path.insert(0, str(SCRIPT_DIR.parents[3] / "common" / "tools"))
from eve_ng import EveNgError, connect_node, discover_ports, require_host  # noqa: E402

DEFAULT_LAB_PATH = "ccnp-encor/network-assurance/lab-00-diagnostics.unl"
DEVICE_NAME = "R1"

FAULT_COMMANDS = [
    "no snmp-server community ENCOR-RO RO",
    "snmp-server community ENCOR-READONLY RO",
]
