#!/usr/bin/env python3
"""
Lab Setup: Security Lab 01 -- AAA Authentication and Authorization

Pushes initial-configs/<node>.cfg to each device via its EVE-NG console
port. Initial configs are the lab-00 solutions: local users, SSH, and OSPF
are pre-configured. AAA is NOT pre-configured — students configure it.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for security lab-01")
    ...
    print("=" * 60)
    print("Lab Setup: Security Lab 01 -- AAA Authentication and Authorization")
    print("=" * 60)
    ...
    if fail:
        ...
        return 1
    print("[+] All devices configured with SSH and local users pre-loaded.")
    print("[*] AAA is NOT pre-configured. Students configure it as part of the lab.")
    return 0
