#!/usr/bin/env python3
"""
Solution Restoration: BGP Lab 02 -- Best Path Selection and Attributes

Pushes the full solution configs from ../../solutions/ to R1, R2, R3, R4,
restoring the lab to complete best-path-selection state (LOCAL_PREF 200
on R1, 150 on R2; MED 50/100 on R3; R4 eBGP fully established).
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore BGP lab-02 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: BGP Lab 02")
    print("=" * 60)
