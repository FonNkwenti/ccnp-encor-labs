#!/usr/bin/env python3
"""
Solution Restoration: IP Services Lab 00 -- NTP and QoS

Pushes the full solution configs from ../../solutions/ to R1, R2, R3,
returning the lab to the known-good end-state with NTP master + clients
+ MD5 authentication all in place.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore IP Services lab-00 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: IP Services Lab 00 (NTP + QoS)")
    print("=" * 60)
