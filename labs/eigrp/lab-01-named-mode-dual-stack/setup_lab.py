#!/usr/bin/env python3
"""
Lab Setup: EIGRP Lab 01 -- Named Mode and Dual-Stack
...
initial-configs are the lab-00 solutions (classic EIGRP, IPv4 only) --
the student's job is to convert to named mode and add IPv6 dual-stack.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Push initial configs for EIGRP lab-01")
    ...
    print("=" * 60)
    print("Lab Setup: EIGRP Lab 01 -- Named Mode and Dual-Stack")
    print("=" * 60)
