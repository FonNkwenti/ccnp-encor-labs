#!/usr/bin/env python3
"""
Solution Restoration: Switching Lab 04 (Capstone I)

Pushes the full solution configs from ../../solutions/ to SW1, SW2, SW3,
and R1, overwriting any injected faults and restoring the lab to a
known-good state (VLANs + trunks + three EtherChannel bundles + Rapid
PVST+ with engineered root + STP enhancements + router-on-a-stick).

PC1 and PC2 are VPCs in EVE-NG and are not pushed from here -- their
configuration is part of `setup_lab.py`.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore switching lab-04 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Switching Lab 04 (Capstone I)")
    print("=" * 60)
