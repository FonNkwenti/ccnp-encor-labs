#!/usr/bin/env python3
"""
Solution Restoration: EIGRP Lab 01 -- Named Mode and Dual-Stack

Pushes the full solution configs from ../../solutions/ to all three routers,
restoring the lab to complete, correct named-mode dual-stack EIGRP state.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore EIGRP lab-01 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: EIGRP Lab 01")
    print("=" * 60)
