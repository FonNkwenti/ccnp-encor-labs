...
Target:     R1 (username operator)
Injects:    Recreates the operator account with privilege level 15.
Fault Type: User Privilege Misconfiguration
...
FAULT_COMMANDS = [
    ...
    "username operator privilege 15 secret Encor-Oper-2026",
]
PREFLIGHT_CMD = "show running-config | section username"
PREFLIGHT_FAULT_MARKER = "username operator privilege 15"
PREFLIGHT_SOLUTION_MARKER = "username operator privilege 7"
