#!/usr/bin/env python3
"""
Solution Restoration: Switching Lab 02
...
known-good state (RSTP + root placement + STP enhancements on top of the
Lab 01 EtherChannel backbone).
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Restore switching lab-02 to solution state")
    ...
    print("=" * 60)
    print("Solution Restoration: Switching Lab 02")
    print("=" * 60)
